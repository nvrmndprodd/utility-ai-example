...
namespace Zenject
{
    public class SceneContext : RunnableContext
    {
        ...
        [FormerlySerializedAs("ParentNewObjectsUnderRoot"), FormerlySerializedAs("_parentNewObjectsUnderRoot"),
         Tooltip("When true, objects that are created at runtime will be parented to the SceneContext"), SerializeField]
